...
- **MCP server** — drive grpc-nimbus from an AI assistant (`go install github.com/CosmicMunkey/grpc-nimbus/cmd/grpc-nimbus-mcp@latest`)
...
```bash
go install github.com/CosmicMunkey/grpc-nimbus/cmd/grpc-nimbus-mcp@latest
```
